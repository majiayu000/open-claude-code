...
var m89 = L(() => {
    ...
    xB = GA(VA(), 1), tR3 = {
        ...
        isActive: () => {
            let A = Kc();
            return AB() && (A.source === /* ENV_AUTH_TOKEN */ "ANTHROPIC_AUTH_TOKEN" || A.source === "apiKeyHelper")
        },
        render: () => {
            let A = Kc();
            return xB.createElement(j, {
        ...
        isActive: () => {
            ...
            return !!rEA() && (A === /* ENV_API_KEY */ "ANTHROPIC_API_KEY" || A === "apiKeyHelper")
        },
        render: () => {
            let {
                source: A
        ...
        render: () => {
            ...
            return xB.createElement(j, {
                ...
                color: "warning"
            }, "• Trying to use", " ", Q.source === "claude.ai" ? "claude.ai" : Q.source, "?", " ", A === /* ENV_API_KEY */ "ANTHROPIC_API_KEY" ? 'Unset the ANTHROPIC_API_KEY environment variable, or claude /logout then say "No" to the API key approval before login.' : A === "apiKeyHelper" ? "Unset the apiKeyHelper setting." : "claude /logout"), xB.createElement($, {
                color: "warning"
