 ...
 * message_start (  3x) = MESSAGE_START event type
 * message_stop (  3x) = MESSAGE_STOP event type
 * server_tool_use (  3x) = SERVER_TOOL_USE type
 * IE         (  2x) = EventSourceIterator class - SSE event processing
 * message_delta (  2x) = MESSAGE_DELTA event type
 * content_block_start (  2x) = CONTENT_BLOCK_START event
 * content_block_delta (  2x) = CONTENT_BLOCK_DELTA event
 * content_block_stop (  2x) = CONTENT_BLOCK_STOP event
...
Please migrate to a newer model. Visit https://docs.anthropic.com/en/docs/resources/model-deprecations for more information.`);
            ...
            return this._client.post(/* MESSAGES_API_ENDPOINT */ "/v1/messages", {
                body: A,
                timeout: B ?? 600000,
                ...Q,
                stream: A.stream ?? !1
        ...
        countTokens(A, Q) {
            return this._client.post(/* TOKEN_COUNT_ENDPOINT */ "/v1/messages/count_tokens", {
                body: A,
                ...Q
            })
        }
    ...
    _GA = class _GA extends cY {
        retrieve(A, Q = {}, B) {
            ...
            return this._client.get(BY`/v1/models/${A}`, {
                ...
                headers: r4([{
                    ...G?.toString() != null ? {
                        /* HEADER_BETA_FEATURES */ "anthropic-beta": G?.toString()
                    } : void 0
                }, B?.headers])
            })
        }
        list(A = {}, Q) {
            ...
            return this._client.getAPIList("/v1/models", NT, {
                ...
                headers: r4([{
                    ...B?.toString() != null ? {
                        /* HEADER_BETA_FEATURES */ "anthropic-beta": B?.toString()
                    } : void 0
                }, Q?.headers])
            })
        }
...
class ZG {
    constructor({
        baseURL: A = LwA(/* ENV_BASE_URL */ "ANTHROPIC_BASE_URL"),
        apiKey: Q = LwA(/* ENV_API_KEY */ "ANTHROPIC_API_KEY") ?? null,
        authToken: B = LwA(/* ENV_AUTH_TOKEN */ "ANTHROPIC_AUTH_TOKEN") ?? null,
        ...G
    } = {}) {
        ...
        let Z = {
            ...
            authToken: B,
            ...G,
            baseURL: A || /* ANTHROPIC_API_BASE_URL */ "https://api.anthropic.com"
        };
...
`);
    ...
    validateHeaders({
        ...
        if (A.get(/* HEADER_API_KEY */ "x-api-key") || A.get("authorization")) return;
        if (this.apiKey && A.get(/* HEADER_API_KEY */ "x-api-key")) return;
        if (Q.has(/* HEADER_API_KEY */ "x-api-key")) return;
    ...
    async buildHeaders({
        ...
        let I = r4([Z, {
            ...
            /* HEADER_API_VERSION */ "anthropic-version": "2023-06-01"
...
var Hf = L(() => {
    ...
    jc1 = ZG, yoA = new WeakMap, Pc1 = new WeakSet, z_B = function() {
        return this.baseURL !== /* ANTHROPIC_API_BASE_URL */ "https://api.anthropic.com"
    };
    ZG.Anthropic = jc1;
    ZG.HUMAN_PROMPT = U_B;
    ZG.AI_PROMPT = $_B;
