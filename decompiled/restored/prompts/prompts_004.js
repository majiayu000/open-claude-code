 ...
 * Kt         (  1x) = MessageStream class - Streaming message handling
 * IE         (  1x) = EventSourceIterator class - SSE event processing
    ...
    WwA = class WwA extends cY {
        list(A = {}, Q) {
            ...
            return this._client.getAPIList("/v1/files", NT, {
                ...
                ...Q,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...B ?? [], "files-api-2025-04-14"].toString()
                }, Q?.headers])
            })
        }
        delete(A, Q = {}, B) {
            ...
            return this._client.delete(BY`/v1/files/${A}`, {
                ...B,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...G ?? [], "files-api-2025-04-14"].toString()
                }, B?.headers])
            })
        }
        download(A, Q = {}, B) {
    ...
    DwA = class DwA extends cY {
        create(A, Q) {
            ...
            return this._client.post("/v1/messages/batches?beta=true", {
                ...
                ...Q,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...B ?? [], "message-batches-2024-09-24"].toString()
                }, Q?.headers])
            })
        }
        retrieve(A, Q = {}, B) {
            ...
            return this._client.get(BY`/v1/messages/batches/${A}?beta=true`, {
                ...B,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...G ?? [], "message-batches-2024-09-24"].toString()
                }, B?.headers])
            })
        }
        list(A = {}, Q) {
        ...
        async results(A, Q = {}, B) {
            ...
            return this._client.get(G.results_url, {
                ...B,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...Z ?? [], "message-batches-2024-09-24"].toString(),
                    Accept: "application/binary"
                }, B?.headers]),
                stream: !0,
                __binaryResponse: !0
...
Please migrate to a newer model. Visit https://docs.anthropic.com/en/docs/resources/model-deprecations for more information.`);
        ...
        parse(A, Q) {
            return Q = {
                ...Q,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...A.betas ?? [], "structured-outputs-2025-09-17"].toString()
                }, Q?.headers])
        ...
        countTokens(A, Q) {
            ...
            return this._client.post("/v1/messages/count_tokens?beta=true", {
                ...
                ...Q,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...B ?? [], "token-counting-2024-11-01"].toString()
                }, Q?.headers])
            })
        }
        toolRunner(A, Q) {
    ...
    HwA = class HwA extends cY {
        create(A, Q = {}, B) {
            ...
            return this._client.post(BY`/v1/skills/${A}/versions?beta=true`, OGA({
                ...
                ...B,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...G ?? [], "skills-2025-10-02"].toString()
                }, B?.headers])
            }, this._client))
        }
        retrieve(A, Q, B) {
            ...
            return this._client.get(BY`/v1/skills/${G}/versions/${A}?beta=true`, {
                ...B,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...Z ?? [], "skills-2025-10-02"].toString()
                }, B?.headers])
            })
        }
        list(A, Q = {}, B) {
    ...
    jGA = class jGA extends cY {
        ...
        create(A = {}, Q) {
            ...
            return this._client.post("/v1/skills?beta=true", OGA({
                ...
                ...Q,
                headers: r4([{
                    /* HEADER_BETA_FEATURES */ "anthropic-beta": [...B ?? [], "skills-2025-10-02"].toString()
                }, Q?.headers])
            }, this._client))
        }
        retrieve(A, Q = {}, B) {
