 ...
 *
 * ===================== 变量索引 =====================
 * IW       (  4x) tokenize(cmd) - Tokenize command
 * vF       (  3x) API_ERROR = "API Error"
 * LW       (  2x) getSmallFastModel() - Returns haiku model
 * J6       (  2x) getProvider() - Returns current provider ("vertex", ...
 ...
 * Kt       (  1x) MessageStream class
 * B7A      (  1x) noOpFunction2() - Empty function
