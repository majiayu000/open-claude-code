 ...
 * M8         (  4x) = shellEscape(args) - Shell escape utility
...
class nm1 {
    ...
    isRetrying = !1;
    constructor(A = {}) {
        let Q = process.env.ANTHROPIC_BASE_URL || /* ANTHROPIC_API_BASE_URL */ "https://api.anthropic.com";
