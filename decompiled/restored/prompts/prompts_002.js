...
var _m0 = U((J87, Sm0) => {
    ...
    function W44(A) {
        let Q = {
            ...
            J = {
                begin: J44("[a-zA-Z_][a-zA-Z0-9\\._]*", /\s*\{/),
                end: /\{/,
                returnBegin: !0,
                relevance: 0,
        ...
        return {
            ...
            compilerExtensions: [(G, Z) => {
                ...
                Object.keys(G).forEach((Y) => {
                    delete G[Y]
                }), G.begin = cH1(I.beforeMatch, F44(I.begin)), G.starts = {
                    relevance: 0,
...
var em0 = U((U87, tm0) => {
    function q44(A) {
        ...
        return V.contains = [I, Y, J, X, F, K, C].concat(W), {
            name: "Scheme",
            illegal: /\S/,
            contains: [A.SHEBANG(), Y, J, F, K, C].concat(W)
        }
    }
    tm0.exports = q44
});
...
var Gd0 = U((w87, Bd0) => {
    var L44 = (A) => {
        ...
        M44 = ["a", "abbr", "address", "article", "aside", "audio", "b", "blockquote", "body", "button", "canvas", "caption", "cite", "code", "dd", "del", "details", "dfn", "div", "dl", "dt", "em", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "html", "i", "iframe", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "mark", "menu", "nav", "object", "ol", "p", "q", "quote", "samp", "section", "span", "strong", "summary", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "time", "tr", "ul", "var", "video"],
        O44 = ["any-hover", "any-pointer", "aspect-ratio", "color", "color-gamut", "color-index", "device-aspect-ratio", "device-height", "device-width", "display-mode", "forced-colors", "grid", "height", "hover", "inverted-colors", "monochrome", "orientation", "overflow-block", "overflow-inline", "pointer", "prefers-color-scheme", "prefers-contrast", "prefers-reduced-motion", "prefers-reduced-transparency", "resolution", "scan", "scripting", "update", "width", "min-width", "max-width", "min-height", "max-height"],
        R44 = ["active", "any-link", "blank", "checked", "current", "default", "defined", "dir", "disabled", "drop", "empty", "enabled", "first", "first-child", "first-of-type", "fullscreen", "future", "focus", "focus-visible", "focus-within", "has", "host", "host-context", "hover", "indeterminate", "in-range", "invalid", "is", "lang", "last-child", "last-of-type", "left", "link", "local-link", "not", "nth-child", "nth-col", "nth-last-child", "nth-last-col", "nth-last-of-type", "nth-of-type", "only-child", "only-of-type", "optional", "out-of-range", "past", "placeholder-shown", "read-only", "read-write", "required", "right", "root", "scope", "target", "target-within", "user-invalid", "valid", "visited", "where"],
    ...
    function j44(A) {
        ...
        return {
            ...
            contains: [A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, {
                ...
                contains: [J, Q.HEXCOLOR, A.CSS_NUMBER_MODE, A.QUOTE_STRING_MODE, A.APOS_STRING_MODE, Q.IMPORTANT]
            }, {
                ...
                contains: [{
                    ...
                    begin: /[a-z-]+(?=:)/,
                    className: "attribute"
                }, J, A.QUOTE_STRING_MODE, A.APOS_STRING_MODE, Q.HEXCOLOR, A.CSS_NUMBER_MODE]
            }]
        }
    }
    Bd0.exports = j44
...
var Jd0 = U((N87, Yd0) => {
    function _44(A) {
        let Q = ["add", "and", "cmp", "cmpg", "cmpl", "const", "div", "double", "float", "goto", "if", "int", "long", "move", "mul", "neg", "new", "nop", "not", "or", "rem", "return", "shl", "shr", "sput", "sub", "throw", "ushr", "xor"],
            ...
            G = ["transient", "constructor", "abstract", "final", "synthetic", "public", "private", "protected", "static", "bridge", "system"];
        return {
            name: "Smali",
            contains: [{
                className: "string",
    ...
    function k44(A) {
        ...
        return {
            ...
            contains: [A.COMMENT('"', '"'), A.APOS_STRING_MODE, {
                ...
                contains: [A.APOS_STRING_MODE, B, A.C_NUMBER_MODE, G]
            }]
        }
    }
    Wd0.exports = k44
    ...
    function v44(A) {
        ...
        return {
            ...
            contains: [{
                ...
                }, A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, Q, A.HASH_COMMENT_MODE]
            }, A.C_BLOCK_COMMENT_MODE, Q, A.HASH_COMMENT_MODE]
        }
    }
    Hd0.exports = v44
});
var Ud0 = U((T87, zd0) => {
    ...
    function f44(A) {
        let Q = A.COMMENT("--", "$"),
            ...
            I = ["double precision", "large object", "with timezone", "without timezone"],
            Y = ["bigint", "binary", "blob", "boolean", "char", "character", "clob", "date", "dec", "decfloat", "decimal", "float", "int", "integer", "interval", "nchar", "nclob", "national", "numeric", "real", "row", "smallint", "time", "timestamp", "varchar", "varying", "varbinary"],
            ...
            V = ["create table", "insert into", "primary key", "foreign key", "not null", "alter table", "add constraint", "grouping sets", "on overflow", "character set", "respect nulls", "ignore nulls", "nulls first", "nulls last", "depth first", "breadth first"],
            K = X,
            D = [...W, ...J].filter((w) => {
                return !X.includes(w)
            }),
        ...
        return {
            ...
            contains: [{
                ...
                className: "type",
                begin: pH1(...I)
            }, E, H, B, G, A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, Q, C]
        }
    }
    zd0.exports = f44
});
var wd0 = U((P87, $d0) => {
    function h44(A) {
        let Q = ["functions", "model", "data", "parameters", "quantities", "transformed", "generated"],
            ...
            G = ["print", "reject", "increment_log_prob|10", "integrate_ode|10", "integrate_ode_rk45|10", "integrate_ode_bdf|10", "algebra_solver"],
            ...
            Y = ["bernoulli", "bernoulli_logit", "beta", "beta_binomial", "binomial", "binomial_logit", "categorical", "categorical_logit", "cauchy", "chi_square", "dirichlet", "double_exponential", "exp_mod_normal", "exponential", "frechet", "gamma", "gaussian_dlm_obs", "gumbel", "hypergeometric", "inv_chi_square", "inv_gamma", "inv_wishart", "lkj_corr", "lkj_corr_cholesky", "logistic", "lognormal", "multi_gp", "multi_gp_cholesky", "multi_normal", "multi_normal_cholesky", "multi_normal_prec", "multi_student_t", "multinomial", "neg_binomial", "neg_binomial_2", "neg_binomial_2_log", "normal", "ordered_logistic", "pareto", "pareto_type_2", "poisson", "poisson_log", "rayleigh", "scaled_inv_chi_square", "skew_normal", "student_t", "uniform", "von_mises", "weibull", "wiener", "wishart"];