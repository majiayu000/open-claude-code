 ...
 *
 * ===================== 变量索引 =====================
 * yP       ( 10x) SLASH_COMMAND_TOOL = "SlashCommand"
 * Pq       (  7x) SKILL_TOOL = "Skill"
 * GA       (  7x) esmImport(module) - ESM import
 * dJ       (  3x) ASK_USER_QUESTION_TOOL = "AskUserQuestion"
 * b31      (  2x) ENTER_PLAN_MODE_TOOL = "EnterPlanMode"
 * kRA      (  1x) EXIT_PLAN_MODE_CONST = "ExitPlanMode"
