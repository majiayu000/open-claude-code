...
var mu0 = U((g47, uu0) => {
    function v94(A) {
        ...
        return {
            ...
            keywords: G,
            illegal: "</",
            contains: [Q, A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, A.C_NUMBER_MODE, A.QUOTE_STRING_MODE, A.APOS_STRING_MODE, {
                className: "string",
                variants: [{
                    begin: '@"',
                    end: '"',
    ...
    function f94(A) {
        let Q = {
            ...
            W = {
                ...
                contains: [Y, A.UNDERSCORE_TITLE_MODE]
            };
        return {
            name: "OpenSCAD",
            aliases: ["scad"],
            ...
            contains: [A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, G, I, Z, Q, J, W]
        }
    }
    pu0.exports = f94
});
    ...
    function h94(A) {
        ...
        return {
            ...
            contains: [B, G, A.C_LINE_COMMENT_MODE, Z, I, A.NUMBER_MODE, Y, {
                ...
                keywords: Q,
                contains: [Z, I, B, G, A.C_LINE_COMMENT_MODE, Y]
            }]
        }
    }
    iu0.exports = h94
...
var ou0 = U((p47, ru0) => {
    function u94(A) {
        ...
        return {
            ...
            contains: [A.HASH_COMMENT_MODE, A.NUMBER_MODE, A.QUOTE_STRING_MODE, Q, B]
        }
    }
    ru0.exports = u94
});
...
var Xm0 = U((r47, Wm0) => {
    function i94(A) {
        let Q = ["string", "char", "byte", "int", "long", "bool", "decimal", "single", "double", "DateTime", "xml", "array", "hashtable", "void"],
            ...
            q = [N, K, Y, A.NUMBER_MODE, X, F, D, J, W, w],
            R = {
                begin: /\[/,
                end: /\]/,
                excludeBegin: !0,
...
var Om0 = U((Z87, Mm0) => {
    ...
    function G44(A) {
        let I = {
            ...
            F = "[0-9](_?[0-9])*",
            V = "(\\b([0-9](_?[0-9])*))?\\.([0-9](_?[0-9])*)|\\b([0-9](_?[0-9])*)\\.",
            K = {
                className: "number",
                relevance: 0,
                variants: [{
