 ...
 * 本文件中使用的混淆变量:
 *   L        (10次) = lazyLoader(fn) - Lazy module loader
 *   R5       (4次) = EDIT_TOOL_NAME = "Edit"
 *   D9       (3次) = BASH_TOOL_NAME = "Bash"
 *   g5       (3次) = READ_TOOL_NAME = "Read"
...
var vX = /* WEB_FETCH_TOOL_NAME */ "WebFetch",
    m7B = `
