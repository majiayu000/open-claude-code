 ...
 *
 * ===================== 变量索引 =====================
 * yqA      (  6x) NO_CORRELATION_ID error
 * fqA      (  5x) UNEXPECTED_ERROR type
 * Dl       (  5x) CLIENT_INFO_DECODING_ERROR
 * QAA      (  5x) REDIRECT_URI_EMPTY error
 * pG       (  3x) esmExport(obj, key) - ESM export
