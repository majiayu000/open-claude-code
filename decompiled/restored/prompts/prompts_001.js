    ...
    function lB4(A) {
        let Q = {
            ...
            G = {
                ...
                }, A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, B]
            },
            Z = {
                begin: /\bstruct\s+/,
                end: /\s/,
            ...
            I = [{
                ...
                contains: [{
                    className: "literal",
                    begin: /\.\.\./
                }, A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, B, Z]
            }],
            Y = {
                className: "title",
                begin: A.UNDERSCORE_IDENT_RE,
            ...
            J = function(K, D, H) {
                ...
                return C.contains.push(Y), C.contains.push(A.C_NUMBER_MODE), C.contains.push(A.C_BLOCK_COMMENT_MODE), C.contains.push(B), C
            },
            W = {
                className: "built_in",
                begin: "\\b(" + Q.built_in.split(" ").join("|") + ")\\b"
            },
            X = {
                className: "string",
                begin: '"',
            ...
            V = {
                ...
                contains: [A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, B, W, F, X, "self"]
            };
        return F.contains.push(V), {
            name: "GAUSS",
            aliases: ["gss"],
            case_insensitive: !0,
            keywords: Q,
            illegal: /(\{[%#]|[%#]\}| <- )/,
            contains: [A.C_NUMBER_MODE, A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, B, X, G, {
                className: "keyword",
                ...
                relevance: 0,
                contains: [A.C_BLOCK_COMMENT_MODE, B, V]
            }, {
                variants: [{
...
var Oh0 = U((f97, Mh0) => {
    function iB4(A) {
        let G = {
            ...
            I = A.inherit(A.C_NUMBER_MODE, {
                begin: "([-+]?((\\.\\d+)|(\\d+)(\\.\\d*)?))|" + A.C_NUMBER_RE
            }),
            Y = [A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, A.COMMENT(/\(/, /\)/), I, A.inherit(A.APOS_STRING_MODE, {
                illegal: null
...
var gh0 = U((p97, hh0) => {
    ...
    function B24(A) {
        let B = uH1([A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, A.COMMENT("/\\*\\*", "\\*/", {
            ...
            Z = uH1([A.BINARY_NUMBER_MODE, A.C_NUMBER_MODE]),
            I = uH1([{
                begin: /"""/,
                end: /"""/
            }, {
        ...
        return {
            ...
            contains: [A.SHEBANG({
                ...
                relevance: 0,
                contains: [B, I, G, Z, "self"]
            }, {
                className: "symbol",
                begin: "^[ \t]*" + A24("[A-Za-z0-9_$]+:"),
                excludeBegin: !0,
                end: "[A-Za-z0-9_$]+:",
                relevance: 0
            }],
...
var Gg0 = U((t97, Bg0) => {
    function $24(A) {
        var Q = "a-zA-Z_\\-!.?+*=<>&#'",
            ...
            z = [H, J, V, K, W, D, F, Y, X, I];
        return H.contains = [A.COMMENT("comment", ""), E, C], C.contains = z, F.contains = z, {
            name: "Hy",
            aliases: ["hylang"],
            illegal: /\S/,
            contains: [A.SHEBANG(), H, J, V, K, W, D, F, Y, X]
        }
    }
    Bg0.exports = $24
});
