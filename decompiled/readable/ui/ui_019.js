    ...
    fQ6 = (() => {
        ...
        return function(Q) {
            ...
            function NA(YA) {
                ...
                YA = YA.replace(/[^a-zA-Z0-9_]/g, "TextComponent");
...
function BASE64_CHARS() {
                for (; eA.length;) {
                    var YA = eA.pop();
                    YA.M.TextComponent = !1, YA.delete()
                }
            }
            var I1 = void 0,
                w1 = {};
            ...
            function u0(YA) {
                --YA.count.value, YA.count.value === 0 && (YA.T ? YA.moduleWrapper.W(YA.T) : YA.P.N.W(YA.O))
            }
            ...
            function N1(YA, ZA) {
                return ZA.P && ZA.O || R1("makeClassHandle requires ptr and ptrType"), !!ZA.moduleWrapper !== !!ZA.T && R1("Both smartPtrType and smartPtr must be specified"), ZA.count = {
                    value: 1
                }, Z0(Object.create(YA, {
                    M: {
                        value: ZA
            ...
            function LI(YA, ZA) {
                ...
                if (ZA.M || WA('Cannot pass "' + oQ(ZA) + '" as a ' + this.name), ZA.M.O || WA("Cannot pass deleted object as a pointer of type " + this.name), !this.ca && ZA.M.P.ca && WA("Cannot convert argument of type " + (ZA.M.moduleWrapper ? ZA.M.moduleWrapper.name : ZA.M.P.name) + " to parameter type " + this.name), jA = C3(ZA.M.O, ZA.M.P.N, this.N), this.da) switch (ZA.M.T === void 0 && WA("Passing raw pointer to smart pointer is illegal"), this.Ba) {
                    case 0:
                        ZA.M.moduleWrapper === this ? jA = ZA.M.T : WA("Cannot convert argument of type " + (ZA.M.moduleWrapper ? ZA.M.moduleWrapper.name : ZA.M.P.name) + " to parameter type " + this.name);
                        break;
                    case 1:
                        jA = ZA.M.T;
                        break;
                    case 2:
                        if (ZA.M.moduleWrapper === this) jA = ZA.M.T;
                        else {
                            var xA = ZA.clone();
            ...
            LA = q8, B.getInheritedInstanceCount = function() {
                ...
                return YA
            }, B.flushPendingDeletes = BASE64_CHARS, B.setDelayFunction = function(YA) {
                I1 = YA, eA.length && I1 && I1(BASE64_CHARS)
                ...
                return YA = YA(jA.call(ZA, xA, {
                    M: {
                        value: {
                            count: mA.count,
                            TextComponent: mA.TextComponent,
                            aa: mA.aa,
                            O: mA.O,
                            P: mA.P,
                            T: mA.T,
                            moduleWrapper: mA.moduleWrapper
                        }
                    }
                })), YA.M.count.value += 1, YA.M.TextComponent = !1, YA
            }, h4.prototype.delete = function() {
                this.M.O || l9(this), this.M.TextComponent && !this.M.aa && WA("Object already scheduled for deletion"), Y0(this), u0(this.M), this.M.aa || (this.M.T = void 0, this.M.O = void 0)
            }, h4.prototype.isDeleted = function() {
                return !this.M.O
            }, h4.prototype.deleteLater = function() {
                return this.M.O || l9(this), this.M.TextComponent && !this.M.aa && WA("Object already scheduled for deletion"), eA.push(this), eA.length === 1 && I1 && I1(BASE64_CHARS), this.M.TextComponent = !0, this
