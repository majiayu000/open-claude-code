 ...
 * 本文件中使用的混淆变量:
 *   L        (13次) = lazyLoader(fn) - Lazy module loader
 *   uY       (6次) = GREP_TOOL_NAME = "Grep"
 *   g5       (4次) = READ_TOOL_NAME = "Read"
 *   CD       (4次) = GLOB_TOOL_NAME = "Glob"
 *   vX       (4次) = WEB_FETCH_TOOL_NAME = "WebFetch"
 *   O_       (4次) = WEB_SEARCH_TOOL_NAME = "WebSearch"
 *   D9       (2次) = BASH_TOOL_NAME = "Bash"
 *   bX       (2次) = WRITE_TOOL_NAME = "Write"
 *   R5       (2次) = EDIT_TOOL_NAME = "Edit"
 *   s8       (2次) = TASK_TOOL_NAME = "Task"
 *   gGB      (2次) = TODO_WRITE_TOOL_NAME = "TodoWrite"
...
var uY = /* GREP_TOOL_NAME */ "Grep";
var XT = () => {};
/* bX = WRITE_TOOL_NAME = "Write" */
var bX = /* WRITE_TOOL_NAME */ "Write",
    CGB;
var L_ = L(() => {
    xV();
...
var O_ = /* WEB_SEARCH_TOOL_NAME */ "WebSearch";
var B7A = () => {};
...
var gGB = /* TODO_WRITE_TOOL_NAME */ "TodoWrite";
var DQ6, HQ6, tI;
var Ht = L(() => {
    h2();
    yGB();
