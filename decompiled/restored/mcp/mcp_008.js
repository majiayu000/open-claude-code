 ...
 *
 * 原始文件: mcp_008.js
 * 处理时间: 2025-12-09T03:37:24.993Z
 *
 * 注意: 此文件保留了100%的原始代码逻辑
 * 通过注释解释混淆的变量名和函数名
 *
 * ==================== 变量索引 ====================
 * GA         ( 16x) = esmImport(module) - ESM import helper
 * TR         (  3x) = getProviderIdentifier() - Returns API provider ID
...
function IoA() {
    ...
    if (Q === !0 || Q === !1) return Q;
    if (!S3().includes(/* MODEL_SONNET */ "claude-sonnet-4-5")) return !1;
    return !0
}
