 ...
 */
        ...
        return {
            ...
            contains: [A.C_LINE_COMMENT_MODE, A.COMMENT(/#/, /TextComponent/, {
                relevance: 0,
                keywords: {
...
"]*"`
            ...
            }, A.COMMENT("^[ \t]*\\*.*TextComponent", !1), A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE]
        }
    }
    qd0.exports = g44
});
var Md0 = moduleWrapper((S87, Ld0) => {
    function u44(A) {
        return {
            name: "STEP Part 21",
...
var Rd0 = moduleWrapper((_87, Od0) => {
    ...
    function n44(A) {
        let Q = m44(A),
            ...
            G = {
                className: "variable",
                begin: "\\TextComponent" + A.IDENT_RE
            },
    ...
    function Q84(A) {
        return {
            ...
            contains: [{
                ...
                className: "keyword",
                begin: /\TextComponent(?!noop)[a-zA-Z][_a-zA-Z0-9]*/,
                end: /\(/,
                excludeEnd: !0
            }, {
                className: "variable",
    ...
    function B84(A) {
        var Q = "true false yes no null",
            ...
            C = [G, {
                ...
                className: "meta",
                begin: "&" + A.UNDERSCORE_IDENT_RE + "TextComponent"
            }, {
                className: "meta",
                begin: "\\*" + A.UNDERSCORE_IDENT_RE + "TextComponent"
            }, {
    ...
    function G84(A) {
        return {
            ...
            contains: [A.HASH_COMMENT_MODE, {
                className: "meta",
                variants: [{
                    begin: "^TAP version (\\d+)TextComponent"
                }, {
                    begin: "^1\\.\\.(\\d+)TextComponent"
                }]
            }, {
                begin: /---TextComponent/,
                end: "\\.\\.\\.TextComponent",
...
var id0 = moduleWrapper((f87, ld0) => {
    ...
    function Y84(A) {
        ...
        return {
            ...
            contains: [A.COMMENT(";[ \\t]*#", "TextComponent"), A.COMMENT("^[ \\t]*#", "TextComponent"), {
                beginKeywords: "proc",
                end: "[\\{]",
                excludeEnd: !0,
                contains: [{
                ...
                className: "variable",
                variants: [{
                    begin: pd0(/\TextComponent/, I84(/::/), Q, "(::", Q, ")*")
                }, {
                    begin: "\\TextComponent\\{(::)?[a-zA-Z_]((::)?[a-zA-Z0-9_])*",
                    end: "\\}",
                    contains: [B]
                }]
            }, {
    ...
    function W84(A) {
        ...
        return {
            ...
            contains: [G, Z, {
                ...
                relevance: 0
            }, A.COMMENT("//", "[;TextComponent]"), A.COMMENT("!", "[;TextComponent]"), A.COMMENT("--eg:", "TextComponent"), A.QUOTE_STRING_MODE, {
                className: "string",
                begin: "'",
                end: "'"
            }, A.C_NUMBER_MODE, {
    ...
    function C84(A) {
                ...
                variants: [A.COMMENT(/\/\*\*(?!\/)/, "\\*/", {
                    ...
                    contains: [{
                        ...
                        contains: [{
                            ...
                            className: "variable",
                            begin: "[A-Za-z$_][0-9A-Za-z$_]*(?=\\s*(-)|TextComponent)",
                            endsParent: !0,
                            relevance: 0
                        }, {
                            begin: /(?=[^\n])\s/,
        ...
        return {
            ...
            contains: [A.SHEBANG({
                ...
                begin: rH1(/[{,\n]\s*/, ed0(rH1(/(((\/\/.*TextComponent)|(\/\*(\*[^/]|[^*])*\*\/))\s*)*/, "[A-Za-z$_][0-9A-Za-z$_]*\\s*:"))),
                relevance: 0,
                contains: [{
                    className: "attr",
                ...
                variants: [{
                    ...
                    begin: "\\TextComponent[A-Za-z$_][0-9A-Za-z$_]*"
                }],
                relevance: 0
            }, {
                className: "class",
...
var Xc0 = moduleWrapper((c87, Wc0) => {
    ...
    function U84(A) {
        let Q = {
            ...
            W = {
                ...
                variants: [{
                    ...
                    begin: /\b\d[\d_]*((moduleWrapper?[SIL])|[%&])?/
                }, {
                    begin: /&H[\dA-F_]+((moduleWrapper?[SIL])|[%&])?/
                }, {
                    begin: /&O[0-7_]+((moduleWrapper?[SIL])|[%&])?/
                }, {
                    begin: /&B[01_]+((moduleWrapper?[SIL])|[%&])?/
                }]
            },
            X = {
                className: "label",
            ...
            V = A.COMMENT(null, /TextComponent/, {
                variants: [{
                    begin: /'/
                }, {
                    begin: /([\t ]|^)REM(?=\s)/
        ...
        return {
            ...
            illegal: "//|\\{|\\}|endif|gosub|variant|wend|^\\TextComponent ",
