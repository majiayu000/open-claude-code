 ...
 *
 * 原始文件: tools_022.js
 * 处理时间: 2025-12-09T03:37:25.673Z
 *
 * 注意: 此文件保留了100%的原始代码逻辑
 * 通过注释解释混淆的变量名和函数名
 *
 * ==================== 变量索引 ====================
 * thinking   ( 16x) = THINKING content type
 * server_tool_use ( 12x) = SERVER_TOOL_USE type
 * IW         (  4x) = tokenize(cmd) - Tokenize bash command
 * tool_use   (  3x) = TOOL_USE content type
 ...
 * M8         (  1x) = shellEscape(args) - Shell escape utility
 * message_start (  1x) = MESSAGE_START event type
 * message_delta (  1x) = MESSAGE_DELTA event type
 * message_stop (  1x) = MESSAGE_STOP event type
 * content_block_start (  1x) = CONTENT_BLOCK_START event
 * content_block_delta (  1x) = CONTENT_BLOCK_DELTA event
 * content_block_stop (  1x) = CONTENT_BLOCK_STOP event
 * text_delta (  1x) = TEXT_DELTA event type
 * ===================================================
 */
