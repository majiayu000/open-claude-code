 ...
 * Xb1      (  4x) SocksStatus enum
 * Fb1      (  4x) defaultConnectionHandler()
 * niA      (  4x) baseSlice()
 * aiA      (  4x) hasUnicode()
 * siA      (  4x) baseEach()
 * j7       (  4x) isArray()
 * x6B      (  3x) Socks5Server class
 * y6B      (  3x) SocksCommand enum
 * u6B      (  3x) baseFindIndex()
 * d6B      (  3x) baseIsNaN()
 * p6B      (  3x) strictIndexOf()
 * i6B      (  3x) baseIndexOf()
 * a6B      (  3x) arrayIncludes()
 * o6B      (  3x) isFlattenable()
 * A5B      (  3x) baseFlatten()
 * B5B      (  3x) flatten()
 * Y5B      (  3x) castSlice()
 * W5B      (  3x) asciiToArray()
 * E5B      (  3x) unicodeToArray()
 * U5B      (  3x) stringToArray()
 * w5B      (  3x) createCaseFirst()
 * N5B      (  3x) upperFirst()
 * o5B      (  3x) baseSet()
 * jj       (  3x) baseIteratee()
 * Pj       (  3x) castPath()
 * Me8      (  2x) Socks5Connection class
 * Re8      (  2x) createSocksServer()
 ...
 * gBA      (  2x) arrayMap()
 * _N       (  2x) toKey()
 * NA6      (  2x) EXPECTED_FUNCTION_ERROR = "Expected a function"
