 ...
 *
 * ===================== 变量索引 =====================
 * Hk       (  3x) CLIENT_ID_KEY = "client_id"
 * eeB      (  3x) COMMA = ","
 * Rl       (  2x) NO_TOKENS_FOUND = "no_tokens_found"
 * GA2      (  2x) SYSTEM_ASSIGNED_MANAGED_IDENTITY type
 * Z01      (  2x) INVALID_FILE_EXTENSION error
 * pG       (  2x) esmExport(obj, key) - ESM export
 * QAA      (  1x) REDIRECT_URI_EMPTY error
