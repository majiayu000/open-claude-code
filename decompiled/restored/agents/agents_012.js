 ...
 *
 * 原始文件: agents_012.js
 * 处理时间: 2025-12-09T03:37:23.670Z
 *
 * 注意: 此文件保留了100%的原始代码逻辑
 * 通过注释解释混淆的变量名和函数名
 *
 * ==================== 变量索引 ====================
 * R5         (  7x) = EDIT_TOOL = "Edit"
 * GA         (  6x) = esmImport(module) - ESM import helper
 * LW         (  1x) = getSmallFastModel() - Returns lightweight/haiku model
 * pG         (  1x) = esmExport(obj, key) - ESM export binding
 * UA         (  1x) = require(moduleName) - Node.js require
 * RJ         (  1x) = isClaudeCodeRemote() - Check if remote execution
