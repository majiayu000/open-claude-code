 ...
 *
 * ===================== 变量索引 =====================
 * o9       ( 14x) getConfig() - Returns config with BASE_API_URL, OAut...
 * J6       (  7x) getProvider() - Returns current provider ("vertex", ...
 * V0       (  6x) parseBoolean(value) - Parse bool env
 * ZI       (  3x) getFeatureFlag(name, scope, default)
 * Yn0      (  2x) SERVICE_VERSION = "claude-code-20250219"
 * KvA      (  2x) USER_INFERENCE_KEY = "user:inference"
