 ...
 * 本文件中使用的混淆变量:
 *   L        (90次) = lazyLoader(fn) - Lazy module loader
 *   HX       (11次) = globalThis - Global object reference
 *   HV       (8次) = Symbol - Symbol reference
 *   Ks       (6次) = Map - Map constructor
 *   _u       (6次) = Array - Array constructor
 *   pG       (3次) = esmExport(obj, key) - ESM export binding
