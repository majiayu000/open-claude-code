 ...
 * 本文件中使用的混淆变量:
 *   SQ       (71次) = sandboxDebug(msg, options) - Debug logging for sandbox
 *   L        (7次) = lazyLoader(fn) - Lazy module loader
 *   GA       (2次) = esmImport(module) - ESM import helper
 *   P6B      (1次) = createProxyServer(config) - Create HTTP/HTTPS proxy server
 *   j6B      (1次) = emptyFunction() - No-op function
 * ======================================================
 */
