 ...
 * RJ         (  2x) = isClaudeCodeRemote() - Check if remote execution
...
` : "", J = A.includes("claude-opus-4") || A.includes(/* MODEL_SONNET */ "claude-sonnet-4-5") || A.includes("claude-sonnet-4") ? `
