 ...
 *
 * ===================== 变量索引 =====================
 * ZQ       (  1x) execGit(cmd, args) - Execute git command
 * ======================================================
 */
 ...
 * Category: mcp
 * File: 9/29
 * Lines: 266041 - 267540 (1500 lines)
 * Original file: cli.js
 */

            let G = await W1.loadWebAssemblyModule(await B, {
                    loadAsync: !0
                }),
                Z = Object.keys(G),
...
${JSON.stringify(Z,null,2)}`), Error("Language.load failed: no language function found in WASM file");
        ...
        return async function(moduleArg = {}) {
            ...
            if (ENVIRONMENT_IS_NODE) {
                ...
                if (readBinary = K0((A) => {
                        ...
                        return Q
                    }, "readBinary"), readAsync = K0(async (A, Q = !0) => {
                        A = isFileURI(A) ? new URL(A) : A;
                ...
                arguments_ = process.argv.slice(2), quit_ = K0((A, Q) => {
            ...
            if (K0(updateMemoryViews, "updateMemoryViews"), Module.wasmMemory) wasmMemory = Module.wasmMemory;
            else {
            ...
            var GOT = {},
                ...
                LE_HEAP_LOAD_F32 = K0((A) => HEAP_DATA_VIEW.getFloat32(A, !0), "LE_HEAP_LOAD_F32"),
                LE_HEAP_LOAD_F64 = K0((A) => HEAP_DATA_VIEW.getFloat64(A, !0), "LE_HEAP_LOAD_F64"),
                LE_HEAP_LOAD_I16 = K0((A) => HEAP_DATA_VIEW.getInt16(A, !0), "LE_HEAP_LOAD_I16"),
                LE_HEAP_LOAD_I32 = K0((A) => HEAP_DATA_VIEW.getInt32(A, !0), "LE_HEAP_LOAD_I32"),
                LE_HEAP_LOAD_U16 = K0((A) => HEAP_DATA_VIEW.getUint16(A, !0), "LE_HEAP_LOAD_U16"),
                LE_HEAP_LOAD_U32 = K0((A) => HEAP_DATA_VIEW.getUint32(A, !0), "LE_HEAP_LOAD_U32"),
                LE_HEAP_STORE_F32 = K0((A, Q) => HEAP_DATA_VIEW.setFloat32(A, Q, !0), "LE_HEAP_STORE_F32"),
                LE_HEAP_STORE_F64 = K0((A, Q) => HEAP_DATA_VIEW.setFloat64(A, Q, !0), "LE_HEAP_STORE_F64"),
                LE_HEAP_STORE_I16 = K0((A, Q) => HEAP_DATA_VIEW.setInt16(A, Q, !0), "LE_HEAP_STORE_I16"),
                LE_HEAP_STORE_I32 = K0((A, Q) => HEAP_DATA_VIEW.setInt32(A, Q, !0), "LE_HEAP_STORE_I32"),
                LE_HEAP_STORE_U16 = K0((A, Q) => HEAP_DATA_VIEW.setUint16(A, Q, !0), "LE_HEAP_STORE_U16"),
                LE_HEAP_STORE_U32 = K0((A, Q) => HEAP_DATA_VIEW.setUint32(A, Q, !0), "LE_HEAP_STORE_U32"),
                callRuntimeCallbacks = K0((A) => {
                    while (A.length > 0) A.shift()(Module)
                }, "callRuntimeCallbacks"),
                onPostRuns = [],
                addOnPostRun = K0((A) => onPostRuns.unshift(A), "addOnPostRun"),
                onPreRuns = [],
                addOnPreRun = K0((A) => onPreRuns.unshift(A), "addOnPreRun"),
                UTF8Decoder = typeof TextDecoder < "u" ? new TextDecoder : void 0,
                UTF8ArrayToString = K0((A, Q = 0, B = NaN) => {
                    var G = Q + B,
                        Z = Q;
                    while (A[Z] && !(Z >= G)) ++Z;
                ...
                getDylinkMetadata = K0((A) => {
                    ...
                    function Z() {
                        ...
                        while (!0) {
                            var d = A[Q++];
                            if (l += (d & 127) * k, k *= 128, !(d & 128)) break
                        }
                        return l
                    }
                    K0(Z, "getLEB");
                    ...
                    if (A instanceof WebAssembly.Module) {
                        ...
                        Y(!F, "need to see wasm magic number"), Y(A[8] !== 0, "need the dylink section to be first"), Q = 9;
                        var V = Z();
                        B = Q + V, J = I()
                    }
                    var K = {
            ...
            var newDSO = K0((A, Q, B) => {
                ...
                ___heap_base = 78224,
                alignMemory = K0((A, Q) => Math.ceil(A / Q) * Q, "alignMemory"),
                getMemory = K0((A) => {
                ...
                isInternalSym = K0((A) => ["__cpp_exception", "__c_longjmp", "__wasm_apply_data_relocs", "__dso_handle", "__tls_size", "__tls_align", "__set_stack_limits", "_emscripten_tls_init", "__wasm_init_tls", "__wasm_call_ctors", "__start_em_asm", "__stop_em_asm", "__start_em_js", "__stop_em_js"].includes(A) || A.startsWith("__em_js__"), "isInternalSym"),
                uleb128Encode = K0((A, Q) => {
                    if (A < 128) Q.push(A);
                ...
                functionsInTableMap, getFunctionAddress = K0((A) => {
                ...
                stackSave = K0(() => _emscripten_stack_get_current(), "stackSave"),
                stackRestore = K0((A) => __emscripten_stack_restore(A), "stackRestore"),
                createInvokeFunction = K0((A) => (Q, ...B) => {
                    var G = stackSave();
                    try {
                ...
                onPostCtors = [],
                addOnPostCtor = K0((A) => onPostCtors.unshift(A), "addOnPostCtor"),
                UTF8ToString = K0((A, Q) => A ? UTF8ArrayToString(HEAPU8, A, Q) : "", "UTF8ToString"),
                loadWebAssemblyModule = K0((binary, flags, libName, localScope, handle) => {
                    ...
                    function loadModule() {
                        ...
                        if (K0(postInstantiation, "postInstantiation"), flags.loadAsync) {
                    ...
                    if (K0(loadModule, "loadModule"), flags.loadAsync) return metadata.neededDynlibs.reduce((A, Q) => A.then(() => loadDynamicLibrary(Q, flags, localScope)), Promise.resolve()).then(loadModule);
                    return metadata.neededDynlibs.forEach((A) => loadDynamicLibrary(A, flags, localScope)), loadModule()
                }, "loadWebAssemblyModule"),
                mergeLibSymbols = K0((A, Q) => {
            ...
            function loadDynamicLibrary(A, Q = {
                ...
                function I() {
                    if (G) {
                        ...
                        if (W && X) {
                            var F = HEAP8.slice(W, W + X);
                            return Q.loadAsync ? Promise.resolve(F) : F
                        }
                    }
                    var V = locateFile(A);
                ...
                if (K0(J, "moduleLoaded"), Q.loadAsync) return Y().then((W) => {
                    return J(W), !0
                });
                return J(Y()), !0
            }
            K0(loadDynamicLibrary, "loadDynamicLibrary");
            var reportUndefinedSymbols = K0(() => {
            ...
            var ___memory_base = new WebAssembly.Global({
                ...
                __abort_js = K0(() => abort(""), "__abort_js");
            __abort_js.sig = "v";
            var _emscripten_get_now = K0(() => performance.now(), "_emscripten_get_now");
            _emscripten_get_now.sig = "d";
            var _emscripten_date_now = K0(() => Date.now(), "_emscripten_date_now");
            _emscripten_date_now.sig = "d";
            var nowIsMonotonic = 1,
                checkWasiClock = K0((A) => A >= 0 && A <= 3, "checkWasiClock"),
            ...
            K0(_clock_time_get, "_clock_time_get"), _clock_time_get.sig = "iijp";
            var getHeapMax = K0(() => 2147483648, "getHeapMax"),
                growMemory = K0((A) => {
            ...
            K0(_tree_sitter_query_progress_callback, "_tree_sitter_query_progress_callback");
            var runtimeKeepaliveCounter = 0,
                keepRuntimeAlive = K0(() => noExitRuntime || runtimeKeepaliveCounter > 0, "keepRuntimeAlive"),
                _proc_exit = K0((A) => {
            ...
            var exitJS = K0((A, Q) => {
                ...
                stringToUTF8 = K0((A, Q, B) => stringToUTF8Array(A, HEAPU8, Q, B), "stringToUTF8"),
                stackAlloc = K0((A) => __emscripten_stack_alloc(A), "stackAlloc"),
                stringToUTF8OnStack = K0((A) => {
            ...
            function run(A = arguments_) {
                ...
                if (K0(Q, "doRun"), Module.setStatus) Module.setStatus("Running..."), setTimeout(() => {
                    setTimeout(() => Module.setStatus(""), 1), Q()
                }, 1);
                else Q()
            }
            if (K0(run, "run"), Module.preInit) {
    ...
    ut1 = class {
        ...
        language = null;
        static async init(A) {
            C22(await O22(A)), z2 = W1._ts_init(), xt1 = W1.getValue(z2, "i32"), vt1 = W1.getValue(z2 + u2, "i32")
        }
        constructor() {
            this.initialize()
        }
        initialize() {
            if (!R22()) throw Error("cannot construct a Parser before calling `init()`");
            W1._ts_parser_new_wasm(), this[0] = W1.getValue(z2, "i32"), this[1] = W1.getValue(z2 + u2, "i32")
        }
        delete() {
            W1._ts_parser_delete(this[0]), W1._free(this[1]), this[0] = 0, this[1] = 0
        }
        setLanguage(A) {
            let Q;
        ...
        parse(A, Q, B) {
            if (typeof A === "string") W1.currentParseCallback = (J) => A.slice(J);
            else if (typeof A === "function") W1.currentParseCallback = A;
            else throw Error("Argument must be a string or a function");
            if (B?.progressCallback) W1.currentProgressCallback = B.progressCallback;
            else W1.currentProgressCallback = null;
            if (this.logCallback) W1.currentLogCallback = this.logCallback, W1._ts_parser_enable_logger_wasm(this[0], 1);
            else W1.currentLogCallback = null, W1._ts_parser_enable_logger_wasm(this[0], 0);
            let G = 0,
                Z = 0;
            if (B?.includedRanges) {
                G = B.includedRanges.length, Z = W1._calloc(G, zLA);
                let J = Z;
                for (let W = 0; W < G; W++) E22(J, B.includedRanges[W]), J += zLA
            }
            let I = W1._ts_parser_parse_wasm(this[0], this[1], Q ? Q[0] : 0, Z, G);
            if (!I) return W1.currentParseCallback = null, W1.currentLogCallback = null, W1.currentProgressCallback = null, null;
            if (!this.language) throw Error("Parser must have a language to parse");
            let Y = new y45(ll, I, this.language, W1.currentParseCallback);
            return W1.currentParseCallback = null, W1.currentLogCallback = null, W1.currentProgressCallback = null, Y
        }
        reset() {
            W1._ts_parser_reset(this[0])
        }
        getIncludedRanges() {
            W1._ts_parser_included_ranges_wasm(this[0]);
            let A = W1.getValue(z2, "i32"),
                Q = W1.getValue(z2 + u2, "i32"),
                B = Array(A);
            if (A > 0) {
                let G = Q;
                for (let Z = 0; Z < A; Z++) B[Z] = JQ1(G), G += zLA;
                W1._free(Q)
            }
            return B
        }
        getTimeoutMicros() {
            return W1._ts_parser_timeout_micros(this[0])
        }
        setTimeoutMicros(A) {
            W1._ts_parser_set_timeout_micros(this[0], 0, A)
        }
        setLogger(A) {
...
function Nk() {
    let A = process.env.ZDOTDIR || WQ1();
    return {
        zsh: mt1(A, ".zshrc"),
        bash: mt1(WQ1(), ".bashrc"),
        fish: mt1(WQ1(), ".config/fish/config.fish")
    }
}
...
function P22() {
    ...
    if (!A) return null;
    let Q = OA(),
        B = A.startsWith("~") ? A.replace("~", WQ1()) : A;
    try {
        if (Q.existsSync(B)) {
            let G = Q.statSync(B);
...
async function ct1() {
    try {
        ...
        if (!OA().existsSync(j22)) {
            let Q = {
                name: "claude-local",
                version: "0.0.1",
                private: !0
            };
            OA().writeFileSync(j22, JSON.stringify(Q, null, 2), {
                encoding: "utf8",
                flush: !1
            })
        }
